...
| 7 | `TICKET-007` | `FEAT-006` | `PHASE-003` | Establishing the foreground session service | inProgress | `docs/planning/tickets/open/TICKET-007-foreground-session-service.md` |
